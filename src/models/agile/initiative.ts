...
export class Initiative {
    ...
    */
     ...
     */
    constructor(idInitiative:string, userStories : Array<UserStory> | undefined, docsReferenced:{wiki:string, attachedFiles:string[]} | undefined){
        this.id = idInitiative;
        this.name = "Iniciativa "+idInitiative;
        this.userStories = userStories;
        this.attachedFiles = docsReferenced?.attachedFiles;
    }
