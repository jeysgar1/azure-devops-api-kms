...
class ConfigInstance {
    ...
    getStates() {
        var _a, _b;
        return ((_b = (_a = this.appConfig) === null || _a === void 0 ? void 0 : _a.states) !== null && _b !== void 0 ? _b : {
            ToDo: [''],
            Doing: [''],
            Done: [''],
            Cancelled: [''],
    ...
    getTypes() {
        var _a, _b;
        return ((_b = (_a = this.appConfig) === null || _a === void 0 ? void 0 : _a.types) !== null && _b !== void 0 ? _b : {
            Epic: 'Not defined',
            Feature: 'Not defined',
            UserStory: 'Not defined',
            Task: 'Not defined',
        });
    }
    onValidate() {
...
const configInstance = (appConfig) => {
