...
export class AzureWorkItem {
    ...
    constructor(workItem) {
        ...
        if (workItem.fields) {
            ...
            if (type == ((_b = (_a = configInstance()) === null || _a === void 0 ? void 0 : _a.getTypes()) === null || _b === void 0 ? void 0 : _b.Epic))
                this.type = WorkItemTypes.Epic;
            else if (type == ((_d = (_c = configInstance()) === null || _c === void 0 ? void 0 : _c.getTypes()) === null || _d === void 0 ? void 0 : _d.Feature))
                this.type = WorkItemTypes.Feature;
            else if (type == ((_f = (_e = configInstance()) === null || _e === void 0 ? void 0 : _e.getTypes()) === null || _f === void 0 ? void 0 : _f.UserStory))
                this.type = WorkItemTypes.UserStory;
            else if (type == ((_h = (_g = configInstance()) === null || _g === void 0 ? void 0 : _g.getTypes()) === null || _h === void 0 ? void 0 : _h.Task))
                this.type = WorkItemTypes.Task;
            else
                this.type = WorkItemTypes.Unknow;
            const state = workItem.fields['System.State'];
            if ((_k = (_j = configInstance()) === null || _j === void 0 ? void 0 : _j.getStates()) === null || _k === void 0 ? void 0 : _k.Cancelled.includes(state))
                this.state = WorkItemStates.Cancelled;
            else if ((_m = (_l = configInstance()) === null || _l === void 0 ? void 0 : _l.getStates()) === null || _m === void 0 ? void 0 : _m.Doing.includes(state))
                this.state = WorkItemStates.Doing;
            else if ((_p = (_o = configInstance()) === null || _o === void 0 ? void 0 : _o.getStates()) === null || _p === void 0 ? void 0 : _p.Done.includes(state))
                this.state = WorkItemStates.Done;
            else if ((_r = (_q = configInstance()) === null || _q === void 0 ? void 0 : _q.getStates()) === null || _r === void 0 ? void 0 : _r.ToDo.includes(state))
                this.state = WorkItemStates.ToDo;
            else
                this.state = WorkItemStates.Unknow;
            const assignedToItem = (_s = workItem.fields['System.AssignedTo']) !== null && _s !== void 0 ? _s : {
                displayName: '',
                uniqueName: '',
            };
            if (assignedToItem) {
            ...
            const createdByItem = (_t = workItem.fields['System.CreatedBy']) !== null && _t !== void 0 ? _t : {
                displayName: '',
                uniqueName: '',
            };
            if (createdByItem) {
            ...
            const architectItem = (_u = workItem.fields['Custom.Arquitecto']) !== null && _u !== void 0 ? _u : {
                displayName: '',
                uniqueName: '',
            };
            if (architectItem) {
            ...
            const scrumMasterItem = (_v = workItem.fields['Custom.ScrumMaster']) !== null && _v !== void 0 ? _v : {
                displayName: '',
                uniqueName: '',
            };
            if (scrumMasterItem) {
            ...
            affectedSystemsSplit === null || affectedSystemsSplit === void 0 ? void 0 : affectedSystemsSplit.forEach((item) => {
                var _a;
                (_a = this.affectedSystems) === null || _a === void 0 ? void 0 : _a.push(item);
            });
            this.linkWiki =
                workItem.fields['Custom.Link_Documento_Arquitectura'];
            this.teamProject = workItem.fields['System.TeamProject'];
            const changedByItem = (_0 = workItem.fields['System.ChangedBy']) !== null && _0 !== void 0 ? _0 : {
                displayName: '',
                uniqueName: '',
            };
            if (changedByItem) {
        ...
        if (workItem.relations) {
            (_1 = workItem.relations) === null || _1 === void 0 ? void 0 : _1.forEach((relation) => {
                ...
                if (this.links) {
                    if (relation.rel == WorkItemLinkType.Hyperlink ||
